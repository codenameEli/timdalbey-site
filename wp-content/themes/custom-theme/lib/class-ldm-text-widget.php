...
if( ! class_exists( 'LDM_Text_Widget' ) ){

    class LDM_Text_Widget extends WP_Widget {

        private static $instance_count = 0;

        public function __construct(){

            parent::__construct( 'ldm_text_widget', "LaunchDM Text Widget", array( 'description' => "Custom text widget." ) );
        }

        public function widget( $args, $instance ){

            $args['before_widget'] = '<section id="' . $args['widget_id'] . '" class="widget widget_ldm_text_widget ldm_widget col-sm-4"><div class="widget-wrap">';
        ...
        public function update( $new_instance, $old_instance ){
            ...
            $instance['button_url'] = ( ! empty( $new_instance['button_url'] ) ? LDM_Utils::parse_link( strip_tags( $new_instance['button_url'] ) ) : '' );
...
add_action( 'widgets_init', 'ldm_register_ldm_text_widget' );
function ldm_register_ldm_text_widget() {

    register_widget( 'LDM_Text_Widget' );
}